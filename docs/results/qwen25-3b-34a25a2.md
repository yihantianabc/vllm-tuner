...
| Attestation tool commit | `ad36ee8e0e15a6d0502a35f9e794b056b9522a82` |
| Attestation tool tree | clean; source-tree SHA-256 `8ea95533232bf6b0d45b75513ec4c799f3ab42595fb66abd5e9893142fbfae7a` |
| Chat root seal | `2026-08-16T03:39:22.962525+00:00`; SHA-256 `7d704beea1890d14f7a411d677b867cdc8a06584a5040dbde2793f6723c8e191` |
| RAG root seal | `2026-08-16T03:40:07.786811+00:00`; SHA-256 `7df0229c115ec0ce41cbc3c72624b13597b2a33d8f93a762242dbe723ca498b7` |
...
The measurement commit remains the provenance of the numbers. The separately recorded clean
`ad36ee8` revision generated the additive root attestation; it did not rewrite sealed trials or
change the measurement commit.
...
- Current 0.6B smoke:
  `/root/autodl-tmp/vllm-tuner-output/slotune-results/smoke-ad36ee8-20260816`
...
- aggregate phase counts, repeat/holdout/capacity tables, and generated plots agree with trial
  data;
- the materialized post-run attestation is additive: `experiment-integrity.json` indexes original
  trial integrity anchors and hashes non-trial aggregate/report/environment files without
  altering sealed trial data;
- it generated `lineage.json` to map phase trials to their source method/trial,
...
For each workload the materialized audit covers 143 sealed entries in total, including 96 trial
anchors, and 96/96 semantic validations. It records 89 COMPLETE plus seven INFEASIBLE statuses, derives 30
repeat/holdout lineage rows from the 96 legacy trials, and renders six scheduler negative
conditions. The original-file hashes remained unchanged before and after attestation:

| Workload | Original `summary.json` SHA-256 | Original scheduler JSON SHA-256 |
|---|---|---|
| Chat | `ade1eaa13a4f78c49c498404c100f2e5458c6a194b1d378ccda283d415a04361` | `c78bdb8d57c5deef51053f41d4e50d8d48f9fe0ee9b5d069220d3a562f138c8b` |
| RAG | `b9da5621b4f075b387a1e2be93968294367249a205992b0c7cffe6acb5895e2f` | `3d382db39c7279b27752137567cc7779c510fd6419f6f995aa29608285b5e1e3` |

Repeating ordinary `attest` on both roots validated the existing seals idempotently and left
their bytes unchanged. Fresh `smoke-ad36ee8-20260816` independently completed two selectable
trials, recorded schema-5 lineage, and produced 37 sealed entries including two anchors, with SHA-256
`4b2552d3e375681ab3e1067962c79d50c777635e23034e539294283af946040c`.
